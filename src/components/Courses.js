  ...
  return (
    <div className="flex flex-col items-start mx-8 space-y-3 mt-14 mb-8">
      ...
      <h3 className="text-xl">
        Choose from 10,000 online video courses with new courses coming up every
        week!
      </h3>
      ...
      <div className="text-left w-full border border-gray-300 p-7">
        ...
        <h3>
          Empower your learning journey through my personalized Udemy platform
          web app, where knowledge meets convenience, and education is tailored
          to your pace.
        </h3>
